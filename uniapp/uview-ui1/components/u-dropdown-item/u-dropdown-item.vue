			...
			>
				<view class="u-dropdown-item__options">
					...
					>
						...
						<view class="cell-right u-flex u-col-center"><u-icon v-if="value == item.value" name="checkbox-mark" :color="activeColor" size="32"></u-icon></view>
					</view>
				</view>
			</scroll-view>
		</block>
