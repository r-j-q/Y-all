 ...
 -->
			...
			<!-- 	<view
					...
					<view class="u-flex">
						...
						<view class="description u-ellipsis-1">
							{{ goodsInfo.activity.richtext_title || '开团/参团·邀请好友·人满发货（不满退款' }}
						</view>
					</view>
					...
					<view class="goods-comment" v-if="tabCurrent === 'tab2'">
						...
						<view class="more-box u-flex u-row-center u-col-center" v-show="commentNum > 3">
							<button class="u-reset-button more-btn u-flex u-row-center u-col-center"
								...
								查看全部
								<view class="u-iconfont uicon-arrow-right" style="color:#d5a65a ;font-size: 28rpx;">
								</view>
							</button>
						</view>
					</view>
					...
					<view class="left u-flex">
						...
						<view class="tools-item u-flex-col u-row-center u-col-center" @tap="goHome">
							<image class="tool-img shopro-selector-circular"
								src="/static/images/tabbar/tabbar_home1.png" mode=""></image>
					...
					<view class="detail-right">
						...
						<view v-if="detailType !== 'score'">
							...
							<view class="detail-btn-box u-flex u-row-around" v-if="!goodsInfo.activity_type">
								...
								<view class=" u-reset-button tool-btn add-btn bach" @tap="jumpCart">去购物车
									<view class="tabJiaoBiao">
										{{cartNum}}
									</view>
								</view>
...
<script>
	...
	export default {
		...
		// 是否登录
		computed: {
			...mapGetters(['isLogin', 'authType', 'cartNum']),
			navbarHeight() {
				// #ifdef APP-PLUS || H5
				return 48;
				// #endif
