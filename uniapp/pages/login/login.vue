					...
					<view class="form-item u-border-bottom">
						<view class="item-content u-flex u-col-center">
							...
							<u-input class="u-m-r-10 u-flex-1" placeholder="请输入密码" :placeholderStyle="placeholderStyle"
								...
								@blur="checkValue($event, 'password')" @input="checkValue($event, 'password')">
							</u-input>
					...
					<view class="form-item u-border-bottom">
						<view class="item-content u-flex u-col-center">
							...
							<u-input class="u-m-r-10 u-flex-1" @blur="checkValue($event, 'Ycode')"
								@input="checkValue($event, 'Ycode')" placeholder="请输入邀请码 (必填)"
								:placeholderStyle="placeholderStyle" v-model="form['register'].data.Ycode"
								type="number">
							</u-input>
...
<style lang="scss" scoped>
	...
	/deep/.uni-app--maxwidth .uni-tabbar {
		opacity: 0 !important;
	}
